...
- [Protenix-v2](https://github.com/bytedance/Protenix/blob/85767b811c40ed46e73a9b39519cf6bfca8701ba/README.md): its upstream README contains conflicting weight terms, reviewed 2026-09-22. Resolve the exact checkpoint terms before use.
- OpenFold3 v0.5.0 with OpenBind v0 parameters until exact code, model-parameter, dependency, and benchmark posture are recorded for the intended use.

...
Recipes are short public-safe workflows for agents and humans. They link the skill, CLI, examples, issue packs, and validation gates without requiring private infrastructure.

| Recipe | Use Case | Starts With | Claim Ceiling |
| --- | --- | --- | --- |
...
| [PDB/EMDB evidence dossier public data](map-model-dossier-public-data.md) | Build a public-accession dossier plan | public PDB/EMDB accession | `public_demo` |
...
All recipes require public or synthetic inputs, explicit non-claims, and an operator gate before any paid provider or license-gated execution.

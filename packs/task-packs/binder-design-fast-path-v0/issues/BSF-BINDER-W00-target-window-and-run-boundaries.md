# BSF-BINDER-W00: Target Window And Run Boundaries
...
- [ ] Result boundary is computational candidate.
...
- `examples/pd-l1-binder-design-public/target-window.json` - owned by this issue

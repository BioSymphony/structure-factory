# BSF-BINDER-W02: Cofold Ranking Contract
...
- [ ] Candidate ranking schema validates.
- [ ] Top-candidate ranking is not treated as binding proof.
...
- `examples/pd-l1-binder-design-public/candidate-ranking.example.json` - owned by this issue

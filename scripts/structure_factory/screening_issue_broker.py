...
def wave_drafts(context: dict[str, Any]) -> list[IssueDraft]:
    return [
        ...
        IssueDraft(
            ...
            summary="Refresh screening campaign contracts for ligand libraries, receptor ensembles, provider profiles, result ledgers, and candidate dossiers.",
            ...
            expected_artifacts=[
                ...
                ("candidate dossier contract", "modules/artifact-contracts/candidate-dossier.v1.json"),
            ],
            stage_contract="n/a",
            artifact_granularity="per-campaign",
            progress_ledger="n/a",
            ...
            acceptance_criteria=[
                ...
                "Contracts keep ligand libraries and receptor ensembles public-safe and small by default.",
            ...
            touched_areas=[
                ...
                ("modules/artifact-contracts/", "screening result and dossier outputs"),
        ...
        IssueDraft(
            ...
            acceptance_criteria=[
                ...
                "Fixture runner emits ranking, failure ledger, provenance, and claim ledger artifacts.",
            ...
            touched_areas=[
                ("examples/screening-superpowers/", "public-safe fixture inputs"),
        ...
        IssueDraft(
            ...
            operator_action_required="none",
            acceptance_criteria=[
                "Compiler recognizes disagreement, discordance, consensus, and method-jury prompts.",
        ...
        IssueDraft(
            ...
            touched_areas=[
                ...
                ("scripts/structure_factory/", "result validation and claim ledger handling"),
        ...
        IssueDraft(
            wave="W10",
            slug="CANDIDATE-DOSSIER-PROMOTION",
            target_state="Backlog",
            summary="Promote top hits, controls, scaffold-diverse cases, disagreement cases, and failures into compact candidate dossiers.",
            wave_input=("wave scope", "candidate dossier promotion and claim ledger"),
            expected_artifacts=[
                ("candidate dossier contract", "modules/artifact-contracts/candidate-dossier.v1.json"),
                ("screening results contract", "modules/artifact-contracts/screening-results.v1.json"),
                ("fixture dossier output", ".runtime/screening-superpowers-fixture/dossiers/"),
            ],
            stage_contract="runpod/stage-contracts/screening-superpowers.stage-contract.json",
            artifact_granularity="per-campaign",
            progress_ledger=".runtime/screening-superpowers-fixture/stage-progress.jsonl",
            ...
            partial_success_policy="close partial if only fixture dossiers exist or if candidate evidence is missing required provenance",
            provider="local",
            execution_profile="screening-no-download-smoke",
            setup_posture="local install",
            writable_volume_env=".runtime/screening-superpowers-fixture",
            ...
            posture="open-default",
            image_runtime_action="run",
            operator_action_required="none for fixture dossier generation",
            acceptance_criteria=[
                "Dossiers include provenance, method summary, failure context, and claim ceiling.",
                "Top-N promotion uses extracted budget/promote constraints where supplied.",
                "Disagreement and representative failure cases are eligible for dossier promotion.",
            ],
            validation_commands=[
            ...
            success_requires="fixture dossiers and screening result checks pass with candidate-only claims",
            touched_areas=[
                ("modules/artifact-contracts/", "candidate dossier contract"),
                ("examples/screening-superpowers/", "fixture input references"),
                ("scripts/structure_factory/", "fixture dossier generator and validator"),
            ],
            dependencies="BSF-SCREENING-W09",
            risk_notes=[
                "Candidate dossiers are ranking artifacts, not validated drug-discovery claims.",

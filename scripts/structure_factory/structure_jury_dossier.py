...
from scripts.structure_factory import poltheta_map_model_dossier as poltheta  # noqa: E402
from scripts.structure_factory import t2r14_open_dossier as t2r14  # noqa: E402
...
"""
    ...
    report_md = """# BioSymphony Structure Factory: Two-Target Structure Jury
...
<body>
<h1>BioSymphony Structure Factory: Two-Target Structure Jury</h1>

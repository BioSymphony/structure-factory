...
RUN_ID = "bsf-demo-poltheta-map-model-dossier"
LINEAR_ISSUE_URL = ""
...
def build_manifest(runner_text: str, self_check_text: str, artifact_contract_text: str) -> dict:
    bundle_b64 = encoded_source_bundle(
        {
            "scripts/structure_factory/poltheta_map_model_dossier.py": runner_text,
...
PY
python3 scripts/structure_factory/poltheta_map_model_dossier.py --out runpod-execution/artifacts --json | tee runpod-execution/artifacts/demo-summary.json
    ...
    return {
        ...
        "workload": {
            ...
            "stage_contract": {
                ...
                "exact_commands": [
                    "python3 scripts/structure_factory/poltheta_map_model_dossier.py --out runpod-execution/artifacts --json",
...
def main() -> int:
    ...
    runner = (ROOT / "scripts" / "structure_factory" / "poltheta_map_model_dossier.py").read_text()

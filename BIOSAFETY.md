...
The repo may help an agent notice biosafety-relevant context, such as non-routine organisms, recombinant designs, high-containment terminology, or public examples that could be misread as execution instructions.

The operator remains responsible for institutional biosafety review, local laws and policies, and the final decision about whether any experiment can proceed.

...
- `BSF-DEMO-01-T2R14-OPEN-RUNPOD-DOSSIER.md`. T2R14 coordinate-dossier demo.
- `BSF-DEMO-02-POLTHETA-MAP-MODEL-RUNPOD-DOSSIER.md`. Pol theta map-model dossier demo.
- `BSF-DEMO-04-STRUCTURE-JURY-DUAL-DOSSIER.md`. Two-lane structure-jury demo.
